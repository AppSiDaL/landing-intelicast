...
import { Brain, Target, Eye, TrendingUp, FileText, Menu, X, QrCode, Phone, Mail, Share2, BarChart3, LineChart, PieChart, Newspaper, Radio, Tv, Globe, Users, Search, Database, FileBarChart, Activity } from "lucide-react"
...
const services = [
  ...
  {
    category: "02. Visión Estratégica y Posicionamiento",
    description: "Análisis que permite al actor posicionarse óptima y estratégicamente en su círculo de interés.",
    icon: Target,
    services: [
      {
        name: "INTELECTA",
  ...
  {
    category: "03. Seguimiento y Evaluación",
    description: "Análisis sistemático derivado del procesamiento de información diario.",
    icon: Eye,
    services: [
      {
  ...
  },
  {
    ...
    description: "Servicios complementarios para campañas y estrategia digital.",
    icon: TrendingUp,
    services: [
      {
        name: "Estrategia Digital y Creación de Contenidos",
        description:
          "Propuestas basadas en la data que monitoreamos. Integramos equipos de Data, Marketing, UX y Arte para soluciones holísticas.",
      },
      {
        name: "Evaluación de Campañas",
        description:
          "Evaluación de campañas gubernamentales: Pre-Test y Post-Test para medir eficiencia, eficacia y cumplimiento de objetivos.",
      },
    ],
  },
]
...
export default function ServiceCatalog() {
  ...
  const iconTypes = [FileText, BarChart3, LineChart, PieChart, Newspaper, Radio, Tv, Globe, Users, Search, Database, FileBarChart, Activity, Brain, Target, Eye]
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-3">
              <Button variant="ghost" size="sm" onClick={() => setShowContact(true)} className="gap-2">
        ...
        <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-24 relative z-10">
          ...
          >
            ...
            <motion.h2 
              ...
              variants={fadeInUp}
            >
              Inteligencia estratégica para la <span className="text-primary">toma de decisiones</span>
            </motion.h2>
            <motion.p 
              className="text-lg lg:text-xl text-muted-foreground text-pretty max-w-2xl mx-auto leading-relaxed"
              variants={fadeInUp}
            >
              Transformamos datos en conocimiento estratégico mediante análisis especializado, monitoreo continuo y
            ...
            >
              ...
              <Button size="lg" variant="outline" className="gap-2 bg-transparent" onClick={() => setShowContact(true)}>
                ...
                <div key={idx} className="space-y-6">
                  ...
                  >
                    ...
                    <div className="flex-1 space-y-2">
                      <h3 className="text-2xl lg:text-3xl font-bold text-foreground">{category.category}</h3>
                  ...
                  >
                    {category.services.map((service, serviceIdx) => (
                      ...
                      >
                        <Card
                          className="p-6 h-full hover:shadow-lg transition-all duration-300 hover:border-primary/50 group"
                        >
                          <motion.div 
                            className="space-y-3"
                            whileHover={{ y: -5 }}
        ...
        <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-24">
          ...
          >
            <h3 className="text-3xl lg:text-4xl font-bold text-balance">
              Tu éxito es nuestro <span className="text-primary">compromiso</span>
            </h3>
            <p className="text-lg text-muted-foreground text-pretty leading-relaxed">
              Contáctanos para conocer cómo nuestros servicios pueden impulsar tu estrategia
            </p>
            <motion.div 
              className="flex flex-wrap gap-4 justify-center pt-4"
            ...
            >
              <Button size="lg" onClick={() => setShowContact(true)} className="gap-2">
                <Mail className="h-5 w-5" />
                Solicitar Información
              </Button>
              <Button size="lg" variant="outline" onClick={() => setShowQR(true)} className="gap-2">
        ...
        <div className="container mx-auto px-4 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <Image src="/intelicast-logo.png" alt="Intelicast" width={120} height={32} className="h-8 w-auto" />
            </div>
            <p className="text-sm text-muted-foreground">© 2025 Intelicast. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
